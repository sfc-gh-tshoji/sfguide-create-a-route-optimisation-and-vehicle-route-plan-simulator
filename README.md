...
This app simulates potential routes to 29 delivery locations for selected customer types - all coming from a user definable wholesaler.  Currently there are 3 types of distributor available:
...
![alt text](img/wholesaler_search.png)
...
![alt text](img/select_wholesaler.png)
...
![alt text](img/vehicle_selection.png)
...
![alt text](img/get_job_routes.png)

![alt text](img/vehicle_details.png)
...
![alt text](img/all_veh_routes.png)
